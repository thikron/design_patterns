...
In diesem Beispiel ist das Fassaden-Designmuster implementiert, um eine vereinfachte Schnittstelle zur Steuerung eines Computers bereitzustellen, der aus verschiedenen Subsystemen besteht.
